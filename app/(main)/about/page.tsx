...
const creators = [
  {
    name: 'Tanish Bawa',
    githubUsername: 'tanishbawa',
    avatarUrl: '',
  },
  {
    name: '',
    githubUsername: '', // Replace with actual username
    avatarUrl: '', // Replace with actual username
  },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-slate-400 max-w-2xl mx-auto mb-8">
            We believe in the power of community. buildfolio is open source, and we welcome contributions of all kinds. The best way to help is by creating and sharing new templates!
          </p>
