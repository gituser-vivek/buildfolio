...
export default function Footer() {
  ...
  const linkCols: LinkColumn[] = [
    ...
    { 
      title: 'Developers', 
      links: [ 
        { name: 'Mail Us', href: 'mailto:officialbawatanish@gmail.com', icon: <FiMail /> }, 
        { name: 'GitHub Repo', href: 'https://github.com/', icon: <FiGithubDev />, target: '_blank' } 
      ] 
    },
  ];
  ...
  return (
    <footer className="bg-slate-900 border-t border-slate-800">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-12">
          ...
          <motion.div variants={footerItemVariants} className="lg:col-span-2">
             <Link href="/" className="flex items-center text-2xl font-bold mb-4">
                ...
                <span className="text-white">Build</span><span className="bg-clip-text text-transparent bg-gradient-to-r from-sky-400 to-cyan-300">folio</span>
            </Link>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <motion.a whileHover={{ y: -3, scale: 1.1 }} href="https://github.com/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-sky-400 transition-colors"><FaGithub size={20} /></motion.a>
        ...
        >
          <p>© {new Date().getFullYear()} buildfolio. All rights reserved.</p>
        </motion.div>
      </motion.div>
    </footer>
  );
